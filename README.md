...
The `recommended` preset enables 112 rules (out of 165 total). See [Preset Rulesets](#preset-rulesets) for other options.
...
Detects issues in T-SQL code. Includes 165 built-in rules covering security, correctness, performance, and coding conventions.
...
| `strict-logic` | 142 | Comprehensive correctness without cosmetic rules |
| `strict` | 165 | Maximum enforcement including style |
