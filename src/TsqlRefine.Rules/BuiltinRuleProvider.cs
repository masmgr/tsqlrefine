...
public sealed class BuiltinRuleProvider : IRuleProvider
{
    ...
    [
        ...
        new InsertMissingRequiredColumnRule(),
        new InsertIntoGeneratedColumnRule(),
        new UpdateColumnNotInTableRule(),
        new UpdateGeneratedColumnRule(),
