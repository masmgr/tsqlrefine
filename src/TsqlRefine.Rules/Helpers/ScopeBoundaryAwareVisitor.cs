...
/// <summary>
/// A base visitor that automatically stops traversal at subquery scope boundaries.
/// Use this for visitors that collect column references within the current scope only.
/// </summary>
/// <remarks>
/// This visitor prevents traversal into:
...
/// </remarks>
public abstract class ScopeBoundaryAwareVisitor : TSqlFragmentVisitor
{
    /// <summary>
