...
/// <param name="RelationsProfilePath">Path to relations profile JSON file generated by 'schema collect-relations'. Relative paths are resolved from the config file directory.</param>
