...
public sealed record FormattingConfig(
    ...
    string SchemaCasing = "none",
    string TableCasing = "none",
    string ColumnCasing = "none",
...
/// </summary>
/// <param name="Path">Unified schema directory path. When set, schema.json, relations.json, and objects.json are derived from this directory unless overridden by their explicit paths.</param>
/// <param name="SnapshotPath">Path to schema snapshot JSON file. Overrides Path for the snapshot. Relative paths are resolved from the config file directory.</param>
/// <param name="DefaultSchema">Default schema for unqualified table references. Default is "dbo".</param>
/// <param name="RelationsProfilePath">Path to relations profile JSON file generated by 'schema collect-relations'. Overrides Path for relations. Relative paths are resolved from the config file directory.</param>
/// <param name="ObjectsCatalogPath">Path to object catalog JSON file generated by 'schema collect-objects'. Overrides Path for objects. Relative paths are resolved from the config file directory.</param>
