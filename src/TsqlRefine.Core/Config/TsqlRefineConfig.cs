...
/// </summary>
/// <param name="Path">Unified schema directory path. When set, schema.json and relations.json are derived from this directory unless overridden by SnapshotPath or RelationsProfilePath.</param>
