...
This document provides a comprehensive overview of all built-in rules in TsqlRefine. TsqlRefine includes 89 rules covering various aspects of T-SQL code quality, from correctness and safety to performance and style.
...
- **Warning Severity**: 49 rules (55%)
- **Information Severity**: 29 rules (33%)
...
|----------|-------|-------------|
| **Correctness** | 25 | Detects code that may produce incorrect results or runtime errors |
